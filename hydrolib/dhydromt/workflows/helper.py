...
__all__ = ["reduce_gdf_precision", "snap_branch_ends", "snap_nodes_to_nodes"]
...
def snap_branch_ends(branches:gpd.GeoDataFrame, offset: float = 0.01, subsets = [],  max_points:int = np.inf, id_col = 'BRANCH_ID'):
    """
